...
void starinfo(int fitsID)
{
	...
	cout << "ra = " << m.ra << ", dec = " << m.dec << "\n";
	cout << "Magnitudes:\n";
	cout << "mag    = "; FOR(0, 3) { cout << m.mag[i] << " "; } cout << "\n";
	cout << "magErr = "; FOR(0, 3) { cout << m.magErr[i] << " "; } cout << "\n";
	cout << "N      = "; FOR(0, 3) { cout << m.N[i] << " "; } cout << "\n";
	cout << "ml_mag = "; FOR(0, 3) { cout << m.ml_mag[i] << " "; } cout << "\n";
	cout << "Distances:\n";
//	cout << "Mr = " << m.Mr << "\n";
	V3 p; calculate_cartesian(p, m);
	cout << "D = " << abs(p) << "\n";
	cout << "(x, y, z) = " << p.x << " " << p.y << " " << p.z << "\n";
}
